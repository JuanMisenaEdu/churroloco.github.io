...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 02-09-2023 a las 07:52:45
...
--
DROP DATABASE IF EXISTS `churroloco`;
...
(118, 'Brisa', '350Ml', 'agua.png', 1200, 10, 1),
(119, 'Cristal', '350Ml', 'agua2.png', 1700, 10, 1),
(120, 'Aguila', '1L', 'cerveza.png', 10500, 10, 3),
(121, 'Corona', 'Caja 12', 'cerveza2.png', 21700, 10, 7),
(122, 'Cocacola', '350 Ml', '2023175622_1535.jpg', 1300, 10, 8);
...
(128, 20, 'domicilio', 'Disponible', ''),
(130, 58, 'mesa', 'Disponible', ''),
(131, 98, 'mesa', 'Disponible', ''),
(135, 2, 'domicilio', 'Disponible', ''),
(137, 3, 'domicilio', 'Disponible', ''),
...
--
ALTER TABLE `pedido`
  MODIFY `id_pedido` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=138;
...
--
ALTER TABLE `servicios`
  MODIFY `id_servicios` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=140;

--
-- AUTO_INCREMENT de la tabla `tipo_producto`
--
ALTER TABLE `tipo_producto`
  MODIFY `id_tipo_producto` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT de la tabla `usuario`
--
ALTER TABLE `usuario`
  MODIFY `id_usuario` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=32;
COMMIT;
